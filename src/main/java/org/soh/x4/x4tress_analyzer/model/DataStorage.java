...
public class DataStorage {
	...
	/**
	 * 
	 * List of ships that are eligible for renaming. The contained list is a
	 * selection of possible names
	 * 
	 * @return the renaming eligible list
	 */
	public Map<String, List<String>> getEligibleForRenaming() {
		return eligibleForRenaming;
	}
